/*
    ...
    https://github.com/chronoxor/CppBenchmark/blob/master/examples/lockfree/mpmc-bounded-queue.hpp

    a lock multiple producer multiple consumer lock free thread safe queue
*/
